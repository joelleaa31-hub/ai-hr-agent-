...
export default function Page() {
  return (
    <main className="container">
      ...
      {/* Hero */}
      <section className="hero" style={{marginTop:16, marginBottom:24}}>
        <h1 className="gradient-text" style={{margin:"0 0 6px 0"}}>Find your next role</h1>
      ...
      <section id="about" className="card" style={{marginTop:24}}>
        ...
        <p className="text-muted">We hire globally and value craftsmanship, empathy, and impact.</p>
      </section>

      <section id="process" className="card" style={{marginTop:16}}>
        <h2 style={{marginTop:0}}>Hiring Process</h2>
        <ol className="text-muted" style={{marginTop:6}}>
